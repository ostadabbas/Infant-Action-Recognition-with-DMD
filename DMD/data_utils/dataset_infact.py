...
class DatasetInfact(Dataset):
    def __init__(self, mode, t_his, t_pred, segments_path=None, actions='all', augmentation=0, stride=1, transform=None, dtype='float32', *args, **kwargs):
        ...
        self.idx_to_class = ['Supine', 'Prone', 'Sitting', 'Standing', 'All-fours','Transition']
    ...
    def _prepare_data(self):
        self.data_file = os.path.join('./data', 'INFANTS_YT_TRAIN_YT_VAL_RP_TEST_3d_pose_fixed.pkl')
